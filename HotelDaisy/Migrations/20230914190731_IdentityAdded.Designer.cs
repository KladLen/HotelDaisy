...
namespace HotelDaisy.Migrations
{
    ...
    [Migration("20230914190731_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelDaisy.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HotelDaisy.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("HotelDaisy.Data.ApplicationUser", "User")
                        .WithMany("Reservations")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HotelDaisy.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
